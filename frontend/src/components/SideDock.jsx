    ...
    return (
        ...
        >
            <motion.div
                ...
                className={`${className} absolute top-1/3 left-2 transform max-w-16 -translate-y-1/2 flex flex-col items-center justify-center h-fit gap-4 rounded-2xl border-neutral-700 border-2 py-4`}
