const RightOverlayContent = ({ isAnimated, setIsAnimated }) => {
    return (
      <div className="p-8 text-center font-primary">
        ...
        <div className="mt-16">
          <button
            className="py-3 px-6 bg-transparent hover:bg-stone-700 cursor-pointer rounded-full text-center text-white font-bold uppercase ring-2 ring-white active:scale-110 transition-transform ease-in"
            onClick={(e) => {
