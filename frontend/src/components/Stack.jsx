                ...
                return (
                    ...
                    >
                        ...
                        >
                            {/* Front */}
                            <div
                                className="absolute w-full h-full bg-white dark:bg-pink-900 rounded-2xl border-2 border-black dark:border-white flex items-center justify-center p-4 shadow-lg text-3xl text-gray-800 dark:text-white"
                            ...
                            {/* Back */}
                            <div
                                className="absolute w-full h-full bg-gray-100 dark:bg-pink-900 rounded-2xl border-2 dark:border-white border-black flex items-center justify-center p-4 shadow-lg text-gray-800 dark:text-white text-3xl font-medium"
